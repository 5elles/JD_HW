...
public class Matrix {
    ...
    /*
    если метод определен в классе содержащем данные, то он должен работать с данными этого класса.
    из этого метода ведь легко получить значения матрицы объекта, на котором он вызывается

    т.о. параметры не нужны, метод сделать нестатическим и тогда при вызове метода у уже созданного объекта
    ты определишь ему поведение распечатать самого себя. с точки зрения ООП это более верный подход
     */
