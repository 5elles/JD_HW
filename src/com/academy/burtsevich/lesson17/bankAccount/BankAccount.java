...
//все верно. обычно так и делают. частая практика с деньгами - хранить значение в интежере, просто умноженном на 100 что бы иметь возможность хранить
//центы или другие дробные части. просто непосредственно перед выводом форматом добавлять точку или делить на 100.
